...
return array(
	...
	'blog_tools:notify:publish:message' => "Bonjour, votre blogue « %s » a été publié. Vous pouvez le visionner ici: %s",	
	'blog_tools:notify:expire:subject' => "Un blogue est expirer",
	'blog_tools:notify:expire:message' =>  "Bonjour, votre blogue « %s » a été publié. Vous pouvez le visionner ici: %s",
