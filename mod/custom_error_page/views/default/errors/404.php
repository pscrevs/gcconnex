...
$vars['title'] = '404';
$vars['body'] = 'My body<br>Delete file';
...
?>
	...
	<div id="elgg-wrapper" class="container-fluid">
		<div class="row">
			<div class="col-sm-12">
		<h1><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Sorry, this page could not be found (<?php echo $str ?>)</h1>
		</div>
		<div class="col-sm-12">The page "<?php echo $str?>" could not be found.</div>
